...
it("Return true when html passes axe tests", async () => {
  const domain = "https://www.example.org";
  const htmlPath = path.resolve(__dirname, "../../__mocks__/pass.html");
...
it("Return false when html fails axe tests", async () => {
  const domain = "https://www.example.org";
